...
lll="C:/Users/User/Desktop/33-modul/airflow_hw/airflow_hw"
...
def pipeline() -> None:
    df = pd.read_csv(f'{lll}/data/train/homework.csv')
    ...
    best_pipe.fit(X, y)
    model_filename = f'{lll}/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
